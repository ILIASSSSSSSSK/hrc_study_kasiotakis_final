...
public:
	...
	int count_x, count_y;
	float last_time;
	std::vector<float> start_pos, start_position_0, start_position_1, start_position_2, start_position_3, start_position_4, start_position_5, start_position_6, start_position_7;
